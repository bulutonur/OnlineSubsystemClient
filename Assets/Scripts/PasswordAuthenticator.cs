...
{
    [Header("Server Credentials")] public string serverPassword;

    [Header("Client Credentials")] public string password;
    ...
    public void OnAuthRequestMessage(NetworkConnectionToClient conn, AuthRequestMessage msg)
    {
        ...
        // On create server is null, so accept it for hosting player
        if (server == null)
        {
        ...
        if (server.pwprotected)
        {
            ...
            if ( msg.authPassword == serverPassword)
            {
